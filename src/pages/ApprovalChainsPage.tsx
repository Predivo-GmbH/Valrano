...
function CreateChainDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose} onKeyDown={(e) => { if (e.key === 'Escape') onClose() }} role="dialog" data-gate-a="ApprovalChainsPage" aria-modal="true" aria-label={editingChain ? 'Edit Approval Chain' : 'Create Approval Chain'}>
