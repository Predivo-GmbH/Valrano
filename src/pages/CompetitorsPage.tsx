...
function AddCompanyDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent data-gate-a="CompetitorsPage" className="sm:max-w-md">
        <DialogHeader>
...
export function CompetitorsPage() {
  ...
  return (
    <>
      <Helmet><title>Competitors - Valrano</title><meta name="robots" content="noindex" /></Helmet>
      <div className="section-fade-in mx-auto max-w-[1200px] px-4 py-8 sm:px-6">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-[13px] text-muted-foreground">
            Manage competitor companies, publication schedules, and review extracted data
          </p>
        </div>
  ...
  return (
    <>
      ...
      <Dialog open={!!deleteConfirm} onOpenChange={(o) => { if (!o) setDeleteConfirm(null) }}>
        <DialogContent data-gate-a="CompetitorsPage-2" className="sm:max-w-sm">
          <DialogHeader>
