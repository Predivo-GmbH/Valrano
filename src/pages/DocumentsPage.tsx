                ...
                {documents.map((doc) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link
                        to={`/documents/${doc.id}`}
                        className="inline-flex min-h-[36px] items-center gap-1.5 rounded-lg px-3 py-1.5 text-[12px] font-medium text-[var(--color-accent)] transition-all duration-200 hover:bg-[var(--color-accent)]/10"
                      >
                        View
