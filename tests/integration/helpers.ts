...
if (!STAGING_URL || !STAGING_ANON_KEY || !STAGING_SERVICE_ROLE_KEY || !TEST_PASSWORD) {
  throw new Error(
    'Missing staging env vars: SUPABASE_STAGING_URL, SUPABASE_STAGING_ANON_KEY, SUPABASE_STAGING_SERVICE_ROLE_KEY, STAGING_TEST_PASSWORD'
  )
}
